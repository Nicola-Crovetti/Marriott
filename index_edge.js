   ...
   content: {
         dom: [
         {
            ...
            c:[
            {
               ...
               fill:["rgba(0,0,0,0)",im+"homebox/box4.png",'0px','0px']
            },
            {
               id:'box_b_1',
               type:'image',
               rect:['0px','0px','767px','628px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"homebox/box1.png",'0px','0px']
            },
            {
               id:'box_b_2',
               type:'image',
               rect:['768px','0px','768px','628px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"homebox/box2.png",'0px','0px']
            },
            {
               id:'box_b_3',
               type:'image',
               rect:['0px','629px','767px','628px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"homebox/box3.png",'0px','0px']
            }]
         }],
         symbolInstances: [
